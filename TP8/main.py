...
def use_processes():
    if __name__ == '__main__':
        ...
        print ("------------- Processus ----------------")
        print("\n")
        process1 = multiprocessing.Process(target=calcul_long)
        process2 = multiprocessing.Process(target=calcul_long)
        process3 = multiprocessing.Process(target=calcul_long)
        process4 = multiprocessing.Process(target=calcul_long)
...
def use_threads():
    ...
    thread1 = threading.Thread(target=calcul_long)
    thread2 = threading.Thread(target=calcul_long)
    thread3 = threading.Thread(target=calcul_long)
    thread4 = threading.Thread(target=calcul_long)
